...
interface AType extends _AType { constructor: { new(): AType }; }

/** The category of operator message */
export type MsgCategoryType = ("Train" | "Station" | "Connections" | "System" | "Misc" | "PriorTrains" | "PriorOther");
interface _MsgCategoryType extends Primitive._string { content: MsgCategoryType; }

/** The severity of operator message */
export type MsgSeverityType = ("0" | "1" | "2" | "3");
interface _MsgSeverityType extends Primitive._string { content: MsgSeverityType; }

interface _PType extends BaseType {
	/** Defines an HTML anchor */
	a?: AType[];
}
interface PType extends _PType { constructor: { new(): PType }; }
...
export interface StationMessage extends _StationMessage { constructor: { new(): StationMessage }; }
...
interface StationMessageMsgType extends _StationMessageMsgType { constructor: { new(): StationMessageMsgType }; }

interface _StationMessageStationType extends BaseType {
	crs: string;
}
interface StationMessageStationType extends _StationMessageStationType { constructor: { new(): StationMessageStationType }; }
