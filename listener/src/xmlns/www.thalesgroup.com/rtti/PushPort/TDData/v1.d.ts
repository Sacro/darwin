...
export interface FullTDBerthID extends _FullTDBerthID { constructor: { new(): FullTDBerthID }; }
...
export interface TrackingID extends _TrackingID { constructor: { new(): TrackingID }; }
