...
export interface PlatformData extends _PlatformData {
  constructor: { new (): PlatformData };
}
export var PlatformData: { new (): PlatformData };

type PlatformDataPlatsrcType = 'P' | 'A' | 'M';
interface _PlatformDataPlatsrcType extends Primitive._string {
  content: PlatformDataPlatsrcType;
}
...
export interface TS extends _TS {
  constructor: { new (): TS };
}
...
export interface TSLocation extends _TSLocation {
  constructor: { new (): TSLocation };
}
...
export interface TSTimeData extends _TSTimeData {
  constructor: { new (): TSTimeData };
}
