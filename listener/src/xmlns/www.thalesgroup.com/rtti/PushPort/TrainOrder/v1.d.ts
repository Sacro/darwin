...
export interface TrainOrder extends _TrainOrder {
  constructor: { new (): TrainOrder };
}
...
export interface TrainOrderData extends _TrainOrderData {
  constructor: { new (): TrainOrderData };
}
...
export interface TrainOrderItem extends _TrainOrderItem {
  constructor: { new (): TrainOrderItem };
}
...
interface TrainOrderItemRidType extends _TrainOrderItemRidType {
  constructor: { new (): TrainOrderItemRidType };
}
