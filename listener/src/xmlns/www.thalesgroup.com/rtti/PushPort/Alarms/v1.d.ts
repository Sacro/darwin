...
export interface RTTIAlarm extends _RTTIAlarm { constructor: { new(): RTTIAlarm }; }
...
export interface RTTIAlarmData extends _RTTIAlarmData { constructor: { new(): RTTIAlarmData }; }
