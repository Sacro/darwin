...
interface _AlertAudienceType extends Primitive._string { content: AlertAudienceType; }
...
export interface AlertService extends _AlertService { constructor: { new(): AlertService }; }
...
export interface AlertServices extends _AlertServices { constructor: { new(): AlertServices }; }
export var AlertServices: { new(): AlertServices };

/** Alert Type Data Type */
export type AlertType = ("Normal" | "Forced");
interface _AlertType extends Primitive._string { content: AlertType; }
...
export interface TrainAlert extends _TrainAlert { constructor: { new(): TrainAlert }; }
