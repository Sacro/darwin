...
import * as for from './Forecasts/v2';
...
interface PportType extends _PportType { constructor: { new(): PportType }; }
...
interface PportTypeFailureRespType extends _PportTypeFailureRespType { constructor: { new(): PportTypeFailureRespType }; }
...
interface PportTypeGetFullSnapshotReqType extends _PportTypeGetFullSnapshotReqType { constructor: { new(): PportTypeGetFullSnapshotReqType }; }

interface _PportTypeGetSnapshotReqType extends BaseType {
	/** If true, then resulting snapshot data is fetched by the client via FTP */
	viaftp?: boolean;
}
interface PportTypeGetSnapshotReqType extends _PportTypeGetSnapshotReqType { constructor: { new(): PportTypeGetSnapshotReqType }; }

interface _PportTypeTimeTableIdType extends ct._TimetableIDType {
	ttfile: string;
	ttreffile: string;
}
interface PportTypeTimeTableIdType extends _PportTypeTimeTableIdType { constructor: { new(): PportTypeTimeTableIdType }; }
...
interface PportTypeURType extends _PportTypeURType { constructor: { new(): PportTypeURType }; }
